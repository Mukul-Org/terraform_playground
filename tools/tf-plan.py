...
def tf(dir):
  ...
  return_code_plan, stdout_plan, stderr_plan = tr.plan_cmd(capture_output=False,auto_approve=True,var={'organization_id':'1234567890', 'billing_account':'ABCD-EFGH-IJKL-MNOP'})
